...
class ThermomixBlock(properties: Properties) : KineticBlock(properties), ITE<ThermomixTile>, ICogWheel {

    override fun getTileEntityClass() = ThermomixTile::class.java
