...
import com.possible_triangle.sliceanddice.api.sprinkler.SimpleSprinklerActionType
...
object PotionAction : SprinkleAction {
    ...
    object Type : SimpleSprinklerActionType<FertilizerAction>(FertilizerAction) {
        override fun tick(
